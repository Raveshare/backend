...
CREATE TABLE "canvases" (
    ...
    "tags" VARCHAR(255)[] DEFAULT (ARRAY[]::character varying[])::character varying(255)[],
...
CREATE TABLE "frames" (
    ...
    "gatedChannels" VARCHAR(255)[] DEFAULT (ARRAY[]::character varying[])::character varying(255)[],
    "gatedCollections" VARCHAR(255)[] DEFAULT (ARRAY[]::character varying[])::character varying(255)[],
